...
from model_visualize_twopulse_utils import *
...
for iD, dataset in enumerate(datasets_lbls):
    ...
    plt.scatter(CEandSC_values[iD, :n_img, 1], CEandSC_values[iD, :n_img, 0], facecolor=color[iD], marker='.', s=30, zorder=-10, alpha=0.5, edgecolors='none')
    ...
    # visualize mean
    plt.scatter(data_mean_sc, data_mean_ce, color=color[iD], label=dataset, s=80, edgecolor='white', zorder=1)
