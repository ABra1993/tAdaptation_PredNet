...
# other scripts
from __model_train_Kirubeswaran2023_utils_corr_wise import CorrWise

from torch.utils.data import Dataset, DataLoader
from __model_train_Kirubeswaran2023_utils_dataloader import VideoDataset
from prednet_pyTorch import *

# code adapted from https://github.com/eijwat/prednet_in_pytorch.git
...
def train(device=torch.device("cpu")):
    ...
    for iInit in range(init):
        ...
        # open log file
        logf = open('losses/' + analyse + '/' + dataset + '_' + str(iInit+1) + '_log_t.txt', 'w')
        ...
        for epoch in range(nb_epoch):
            ...
            torch.save(net.state_dict(), '/weights/Brands2024/' + analyse + '/' + dataset + '_' + str(iInit+1) + '.pth')
