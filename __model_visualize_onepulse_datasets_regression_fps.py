...
# analysis        = 'loss'
# training_sets   = ['Lnull_WT_VEN', 'Lnull_WT_VEN']
...
# plot_regression_all_fps(test_sets, ratio_lin_log, ratio_trans_sust, training_sets, n_layer, color_layer, n_img, init, root_vis, dataset)
...
# plot_regression_all_fps_old(test_sets, ratio_lin_log, ratio_trans_sust, training_sets, n_layer, color_layer, n_img, init, root_vis, dataset)
...
######################## VISUALIZE
plot_regression_all_datasets_fps(test_sets, ratio_lin_log_all, None, training_sets, n_layer, color_layer, n_img, init, root_vis, datasets)
