...
from __model_train_Kirubeswaran2023_utils_flow import warp, clip_flow, normalize_flow
...
class CorrWise(nn.Module):
    def __init__(self, 
        ...
        if flow_method == 'RAFT':
            from __model_train_Kirubeswaran2023_utils_flow import RAFT
            self.flow_method = RAFT()
        elif flow_method == 'PWC':
            from __model_train_Kirubeswaran2023_utils_flow import PWCNet
            self.flow_method = PWCNet()
        elif flow_method == 'FBFlow':
            from __model_train_Kirubeswaran2023_utils_flow import FBFlow
